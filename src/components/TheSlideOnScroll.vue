	...
	computed: {
		slide_style() {
			let style = {
				...
				'opacity': this.set_opacity,
				'-ms-transform': 'translate(' + this.set_X + 'px,' + this.set_Y + 'px)',
				'-webkit-transform': 'translate(' + this.set_X + 'px,' + this.set_Y + 'px)',
				'transform': 'translate(' + this.set_X + 'px,' + this.set_Y + 'px)'*/
				'--tx': this.set_X + 'px',
				'--ty': this.set_Y + 'px'
			}
			return style
